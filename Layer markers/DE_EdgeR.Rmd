...
```{r}
for (i in 1:ncls){
  write.csv(qlf[[1]]$table, file=paste0('results/humanDE/degenes_', levels(layer)[i], '.csv'))
}
```
...
```{r}
for (i in 1:ncls){
  write.csv(qlf[[1]]$table, file=paste0('results/chimpDE/degenes_', levels(layer)[i], '.csv'))
}
```
...
```{r}
for (i in 1:ncls){
  write.csv(qlf[[1]]$table, file=paste0('results/macaqueDE/degenes_', levels(layer)[i], '.csv'))
}
```
